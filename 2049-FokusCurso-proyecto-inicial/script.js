...
const imagenPausar = document.querySelector('.app__card-primary-butto-icon');
...
const cuentaRegresiva = () => {
    ...
    imagenPausar.setAttribute('src', `./imagenes/pause.png`);
...
function reiniciar() {
    ...
    imagenPausar.setAttribute('src', `./imagenes/play_arrow.png`);
}
